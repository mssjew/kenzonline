...
setTimeout(() => {
  axios
    ...
    .then((resp) => {
      ...
      th2.style.backgroundColor = "#005757";
      th3.style.backgroundColor = "#005757";
...
setTimeout(() => {
  ...
  allRow.style.backgroundColor = "#005757";
...
setTimeout(() => {
  ...
  sliderDiv.innerHTML =
    '<br><p id="demo"></p><input type="range" min="2000" max="3000" value="2300" class="slider" id="myRange">';

...
const URL_ONE = "1_gYW1JXBL5Wqc-e--AHZ_Zgw56p132E858mJ1_v5Uzk";
...
axios
  .get(
    `https://sheets.googleapis.com/v4/spreadsheets/${URL_ONE}/values/${internalPos}?key=${URL_TWO}`
  )
  .then((resp) => {
...
axios
  .get(
    `https://sheets.googleapis.com/v4/spreadsheets/${URL_ONE}/values/${netPos}?key=${URL_TWO}`
  )
  .then((resp) => {
...
axios
  .get(
    `https://sheets.googleapis.com/v4/spreadsheets/${URL_ONE}/values/${sellRange}?key=${URL_TWO}`
  )
  .then((resp) => {
...
axios
  .get(
    `https://sheets.googleapis.com/v4/spreadsheets/${URL_ONE}/values/${totalSold}?key=${URL_TWO}`
  )
  .then((resp) => {
...
axios
  .get(
    `https://sheets.googleapis.com/v4/spreadsheets/${URL_ONE}/values/${avgSell}?key=${URL_TWO}`
  )
  .then((resp) => {
...
axios
  .get(
    `https://sheets.googleapis.com/v4/spreadsheets/${URL_ONE}/values/${buyRange}?key=${URL_TWO}`
  )
  .then((resp) => {
    if(resp.data.values[0][0] === "#N/A") {
...
axios
  .get(
    `https://sheets.googleapis.com/v4/spreadsheets/${URL_ONE}/values/${totalBought}?key=${URL_TWO}`
  )
  .then((resp) => {
...
axios
  .get(
    `https://sheets.googleapis.com/v4/spreadsheets/${URL_ONE}/values/${avgBuy}?key=${URL_TWO}`
  )
  .then((resp) => {
    if(resp.data.values[0][0] === "#DIV/0!") {
...
axios
  .get(
    `https://sheets.googleapis.com/v4/spreadsheets/${URL_ONE}/values/${amtToday}?key=${URL_TWO}`
  )
  .then((resp) => {
    if (resp.data.values[0][0] === "#N/A") {
...
axios
.get(
  `https://sheets.googleapis.com/v4/spreadsheets/${URL_ONE}/values/${totalDailyP}?key=${URL_TWO}`
)
.then((resp) => {
